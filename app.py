...
app.layout=html.Div(id='parent',children=[
    ...
    html.Div(id='bottom_bar',className='bottom_info',children=[
        html.A('App by Etienne Auroux',href='https://etienneauroux.com',id='signature',className='sign_name',target='_blank')
        ])
    ])
...
media_array=['tweet_image1','tweet_image2','tweet_image3','tweet_image4','tweet_image5']
...
for i in range(0,5):
    ...
    def tweet(selected_value,data,i=i):
        if selected_value=='Top five tweets':
            ...
            return profile_picture,account_name,public_name,top_content[i],top_dates[i],top_times[i],top_reply[i],top_retweet[i],top_like[i],top_url[i]
        else:
            return '','','','','','','','','',''       
